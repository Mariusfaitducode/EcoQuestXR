...
//     {
//         // V�rifiez s'il y a des cartes � placer
//         if (cards.Count == 0)
//             return;
//
...
//
//         // Rayon du cercle sur lequel les cartes seront plac�es
//         float radius = 1.5f;
//
//         // Angle total couvert par les cartes
//         float totalAngle = 120.0f;
//
//         // Angle initial pour la premi�re carte
//         float startAngle = -totalAngle / 2.0f;
//
//         // Angle entre chaque carte
//         float angleIncrement = cardCount > 1 ? totalAngle / (cardCount - 1) : 0f; // V�rifie si cardCount > 1 pour �viter la division par z�ro
//
...
//
//             // Calculez l'angle de rotation � partir de la direction
